...
class MainScreen extends Component{
    ...
    render(){
        return(
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff1e1'}}>
                    <Image source={require('../assets/images/eating-lunch.png')} style={{width: 400, height:400}} />
                    <Text style={{alignSelf: 'center', fontSize: 20, fontFamily:'Lato-Regular'}}>Input your table number</Text>                
                    <View style={{borderRadius:5, borderWidth: 0.7, width: '45%', alignSelf:'center', marginTop: 10, borderColor: 'grey'}}>
                ...
                <TouchableOpacity style={{ alignSelf: 'center', marginTop: 8, backgroundColor: '#ff8d58', borderWidth: 1, width: '45%', paddingVertical: 5, borderRadius: 5, borderColor: '#ff8d58', elevation: 7 }} onPress={() => this.onSubmit()} >
